...
import '../datasources/walker_availability_remote_datasource.dart';
import '../models/availability_exception_dto.dart';
import '../models/availability_slot_dto.dart';

class WalkerAvailabilityRepositoryImpl implements WalkerAvailabilityRepository {
  WalkerAvailabilityRepositoryImpl(this._remote);

  final WalkerAvailabilityRemoteDataSource _remote;
